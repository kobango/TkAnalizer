...
def MasDataRead(path,number,slice):
    ...
    for a in range (1,number):
        ## Read Imput Data
        example_filename = os.path.join(data_path, path+'\\imagesTr\\BRATS_'+str(a).zfill(3)+'.nii.gz')
        ...
        ## Read labels Data
        example_filename2 = os.path.join(data_path, path+'\\labelsTr\\BRATS_'+str(a).zfill(3)+'.nii.gz')
